...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{ base_url() }}assets/bower_components/AdminLTE/dist/css/skins/_all-skins.min.css">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <!-- Slimscroll -->
    <script src="{{ base_url() }}assets/bower_components/AdminLTE/plugins/slimScroll/jquery.slimscroll.min.js"></script>
    <!-- FastClick -->
    <script src="{{ base_url() }}assets/bower_components/AdminLTE/plugins/fastclick/fastclick.js"></script>
    <!-- AdminLTE App -->
